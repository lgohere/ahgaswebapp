"""
Django settings for pedidosahgas project.
...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="pedidosahgas.fly.dev",
    cast=lambda v: [s.strip() for s in v.split(",")],
)

CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS",
    default="https://pedidosahgas.fly.dev",
    cast=lambda v: [s.strip() for s in v.split(",")],
)
...
ROOT_URLCONF = "pedidosahgas.pedidosahgas.urls"
...
WSGI_APPLICATION = (
    "pedidosahgas.pedidosahgas.wsgi.application"
)
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './pedidosahgas.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
